...
//  SecureHashAlgorithm
//
//  Created by Mihnea Stefan on 02/07/2020.
...
#define ROTR(number, times) (number>>times|number<<(64-times))
#define LOWERSIGMA0(number) (ROTR(number,1)^ROTR(number,8)^(number>>7))
#define LOWERSIGMA1(number) (ROTR(number,19)^ROTR(number,61)^(number>>6))
#define SIGMA0(number) (ROTR(number,28)^ROTR(number,34)^ROTR(number,39))
#define SIGMA1(number) (ROTR(number,14)^ROTR(number,18)^ROTR(number,41))
